...
export default function BreadcrumbSection(props) {
	...
	return (
		<>
			{props.news && (
				<div className="fugu--breadcrumbs-section imageBG">
												...
												<li>
													<Link href={'#'}>
														...
														{props.news.createdAt &&
															format(new Date(props.news.createdAt), 'dd MMMM yyyy')}
													</Link>
												</li>
											</ul>
										</div>
								...
								<Tabs defaultActiveKey="general" className="fugu-tab-menu">
									<Tab eventKey="general" title="Buy Now & Download">
										<p className="small-text">
											Starting from July 1st, 2023, single video download purchases will be
											available for a limited period of 30 days.please refer to our updated terms
											and policies.
										</p>
										<button
									...
									<Tab eventKey="general2" title="Subscribe & Save">
										<p className="small-text">
											Save big with our membership plans starting from just Rs.199! Unlock a world
											of benefits and exclusive content. Upgrade today and enjoy unlimited access.
											Don't miss out!
										</p>
										<button
											onClick={() => handlePayment(300)}
